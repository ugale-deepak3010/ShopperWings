...
<br>
    ...
    <div class="form-floating">
      <input type="text" class="form-control" required="" id="address" autocomplete="true" placeholder="First Name">
      <label for="fname">Shop Address</label>
    </div>
<br>
